...
mkTag store tag ty offset count = case tag of
    ...
    257     -> maker mkWord32        >>= unlist >>= \v -> Just $ SigSize v
    ...
    270     -> maker mkWord64        >>= unlist >>= \v -> Just $ LongSigSize v
    271     -> maker mkWord64        >>= unlist >>= \v -> Just $ LongArchiveSize v

    1000    -> maker mkString        >>=            \v -> Just $ Name v
    1001    -> maker mkString        >>=            \v -> Just $ Version v
    1002    -> maker mkString        >>=            \v -> Just $ Release v
    1003    -> maker mkWord32        >>= unlist >>= \v -> Just $ Epoch v
    1004    -> maker mkI18NString    >>=            \v -> Just $ Summary v
    1005    -> maker mkI18NString    >>=            \v -> Just $ Description v
    1006    -> maker mkWord32        >>= unlist >>= \v -> Just $ BuildTime v
    1007    -> maker mkString        >>=            \v -> Just $ BuildHost v
    1008    -> maker mkWord32        >>= unlist >>= \v -> Just $ InstallTime v
    1009    -> maker mkWord32        >>= unlist >>= \v -> Just $ Size v
    ...
    1046    -> maker mkWord32        >>= unlist >>= \v -> Just $ ArchiveSize v
    ...
    1105    -> maker mkWord32        >>= unlist >>= \v -> Just $ INTERNAL $ OBSOLETE $ Capability v
    1106    -> maker mkWord32        >>= unlist >>= \v -> Just $ SourcePackage v
    ...
    1127    -> maker mkWord32        >>= unlist >>= \v -> Just $ InstallColor v
    1128    -> maker mkWord32        >>= unlist >>= \v -> Just $ InstallTID v
    1129    -> maker mkWord32        >>= unlist >>= \v -> Just $ RemoveTID v
    ...
    1136    -> maker mkWord32        >>= unlist >>= \v -> Just $ INTERNAL $ OBSOLETE $ CacheCTime v
    1137    -> maker mkString        >>=            \v -> Just $ INTERNAL $ OBSOLETE $ CachePkgPath v
    1138    -> maker mkWord32        >>= unlist >>= \v -> Just $ INTERNAL $ OBSOLETE $ CachePkgSize v
    1139    -> maker mkWord32        >>= unlist >>= \v -> Just $ INTERNAL $ OBSOLETE $ CachePkgMTime v
    ...
    1176    -> maker mkWord32        >>= unlist >>= \v -> Just $ UNIMPLEMENTED $ BuildCPUClock v
    1177    -> maker mkWord32        >>=            \v -> Just $ UNIMPLEMENTED $ FileDigestAlgos v
    1178    -> maker mkStringArray   >>=            \v -> Just $ UNIMPLEMENTED $ Variants v
    1179    -> maker mkWord32        >>= unlist >>= \v -> Just $ UNIMPLEMENTED $ XMajor v
    1180    -> maker mkWord32        >>= unlist >>= \v -> Just $ UNIMPLEMENTED $ XMinor v
    ...
    1184    -> maker mkWord32        >>= unlist >>= \v -> Just $ UNIMPLEMENTED $ PackageColor v
    1185    -> maker mkWord32        >>= unlist >>= \v -> Just $ UNIMPLEMENTED $ PackagePrefColor v
    ...
    1195    -> maker mkWord32        >>= unlist >>= \v -> Just $ DBInstance v
    ...
    5009    -> maker mkWord64        >>= unlist >>= \v -> Just $ LongSize v
    5010    -> maker mkStringArray   >>=            \v -> Just $ FileCaps v
    5011    -> maker mkWord32        >>= unlist >>= \v -> Just $ FileDigestAlgo v
    ...
    5017    -> maker mkWord32        >>= unlist >>= \v -> Just $ HeaderColor v
    5018    -> maker mkWord32        >>= unlist >>= \v -> Just $ Verbose v
    5019    -> maker mkWord32        >>= unlist >>= \v -> Just $ EpochNum v
    5020    -> maker mkWord32        >>= unlist >>= \v -> Just $ PreInFlags v
    5021    -> maker mkWord32        >>= unlist >>= \v -> Just $ PostInFlags v
    5022    -> maker mkWord32        >>= unlist >>= \v -> Just $ PreUnFlags v
    5023    -> maker mkWord32        >>= unlist >>= \v -> Just $ PostUnFlags v
    5024    -> maker mkWord32        >>= unlist >>= \v -> Just $ PreTransFlags v
    5025    -> maker mkWord32        >>= unlist >>= \v -> Just $ PostTransFlags v
    5026    -> maker mkWord32        >>= unlist >>= \v -> Just $ VerifyScriptFlags v
    ...
    5091    -> maker mkWord32        >>= unlist >>= \v -> Just $ FileSignatureLength v
